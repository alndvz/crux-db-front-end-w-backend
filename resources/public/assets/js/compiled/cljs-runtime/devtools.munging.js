...
var o27508 = temp__5751__auto__;
var temp__5751__auto____$1 = (o27508["core"]);
if(cljs.core.truth_(temp__5751__auto____$1)){
var o27509 = temp__5751__auto____$1;
return (o27509["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__26690__auto__ = f;
return (o__26690__auto__["toString"]).call(o__26690__auto__);
} else {
return "";
}
}catch (e27515){var _ = e27515;
return "";
}});
...
try{var o__26690__auto___27876 = t;
(o__26690__auto___27876["cljs$lang$ctorPrWriter"]).call(o__26690__auto___27876,t,writer);
}catch (e27556){var __27877 = e27556;
}
...
var char_code = (function (){var o__26690__auto__ = (new String(char$));
return (o__26690__auto__["charCodeAt"]).call(o__26690__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__26690__auto__ = String;
return (o__26690__auto__["fromCharCode"]).call(o__26690__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__27583 = num_code;
switch (G__27583) {
case (1):
return (185);
...
var o__26690__auto__ = String;
return (o__26690__auto__["fromCharCode"]).call(o__26690__auto__,superscript_code);
});
/**
...
}catch (e27604){var _e__26711__auto__ = e27604;
return false;
}})())){
...
var vec__27611 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27611,(0),null);
...
var len__4829__auto___27894 = arguments.length;
var i__4830__auto___27895 = (0);
while(true){
if((i__4830__auto___27895 < len__4829__auto___27894)){
args__4835__auto__.push((arguments[i__4830__auto___27895]));

var G__27897 = (i__4830__auto___27895 + (1));
i__4830__auto___27895 = G__27897;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__27647){
var vec__27651 = p__27647;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27651,(0),null);
...
var G__27899 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__27900 = cljs.core.butlast(remaining_tokens);
name_tokens = G__27899;
remaining_tokens = G__27900;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq27637){
var G__27638 = cljs.core.first(seq27637);
var seq27637__$1 = cljs.core.next(seq27637);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27638,seq27637__$1);
}));
...
var vec__27661 = cljs.core.split_with((function (p1__27660_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__27660_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27661,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27661,(1),null);
...
var vec__27673 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27673,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27673,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__27906 = cljs.core.rest(remaining_tokens);
var G__27907 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__27906;
name_tokens = G__27907;
continue;
} else {
...
var vec__27685 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27685,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27685,(1),null);
var vec__27688 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27688,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27688,(1),null);
var vec__27691 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27691,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27691,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27691,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27691,(3),null);
...
var vec__27741 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27741,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27741,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27741,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27741,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27741,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27741,(5),null);
...
if(cljs.core.truth_(temp__5751__auto__)){
var vec__27754 = temp__5751__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27754,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27754,(1),null);
var vec__27758 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27758,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27758,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__27765 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__27765) : devtools.munging.parse_fn_info_deep.call(null,G__27765));
})()));
}
} else {
return fn_info;
...
var G__27931 = (arity + (1));
var G__27932 = (function (){var temp__5751__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5751__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__27783){
var vec__27785 = p__27783;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27785,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27785,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__27794_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__27794_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__27795_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__27795_SHARP_);
}),sorted_infos);
...
var args__4835__auto__ = [];
var len__4829__auto___27946 = arguments.length;
var i__4830__auto___27947 = (0);
while(true){
if((i__4830__auto___27947 < len__4829__auto___27946)){
args__4835__auto__.push((arguments[i__4830__auto___27947]));

var G__27948 = (i__4830__auto___27947 + (1));
i__4830__auto___27947 = G__27948;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__27806){
var vec__27807 = p__27806;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27807,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq27797){
var G__27798 = cljs.core.first(seq27797);
var seq27797__$1 = cljs.core.next(seq27797);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27798,seq27797__$1);
}));
...
var G__27811 = arg;
var G__27811__$1 = (((G__27811 instanceof cljs.core.Keyword))?G__27811.fqn:null);
switch (G__27811__$1) {
...
var map__27823 = options;
var map__27823__$1 = cljs.core.__destructure_map(map__27823);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27823__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27823__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27823__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27823__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__27824 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27824,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27824,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27824,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27824,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27824,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27824,(5),null);
...
var o__26690__auto__ = f;
return (o__26690__auto__["getBasis"]).call(o__26690__auto__);
});
/**
...
}catch (e27833){var _e__26711__auto__ = e27833;
...
var G__27955 = (obj[cljs.core.first(path)]);
var G__27956 = cljs.core.rest(path);
obj = G__27955;
path = G__27956;
continue;
} else {
...
var _STAR_ = (function (accum,p__27845){
var vec__27846 = p__27845;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27846,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27846,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__27850){
var vec__27851 = p__27850;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27851,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27851,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27851,(2),null);
...
var post_process = (function (p__27858){
var vec__27859 = p__27858;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27859,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27859,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__27857_SHARP_){
return (obj[cljs.core.first(p1__27857_SHARP_)]);
}),sorted_matches);
