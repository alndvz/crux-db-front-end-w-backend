...
var o30964 = temp__5751__auto__;
var temp__5751__auto____$1 = (o30964["core"]);
if(cljs.core.truth_(temp__5751__auto____$1)){
var o30965 = temp__5751__auto____$1;
return (o30965["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__30491__auto__ = f;
return (o__30491__auto__["toString"]).call(o__30491__auto__);
} else {
return "";
}
}catch (e30976){var _ = e30976;
return "";
}});
...
try{var o__30491__auto___31355 = t;
(o__30491__auto___31355["cljs$lang$ctorPrWriter"]).call(o__30491__auto___31355,t,writer);
}catch (e30991){var __31356 = e30991;
}
...
var char_code = (function (){var o__30491__auto__ = (new String(char$));
return (o__30491__auto__["charCodeAt"]).call(o__30491__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__30491__auto__ = String;
return (o__30491__auto__["fromCharCode"]).call(o__30491__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__31012 = num_code;
switch (G__31012) {
case (1):
return (185);
...
var o__30491__auto__ = String;
return (o__30491__auto__["fromCharCode"]).call(o__30491__auto__,superscript_code);
});
/**
...
}catch (e31051){var _e__30527__auto__ = e31051;
return false;
}})())){
...
var vec__31053 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31053,(0),null);
...
var or__4223__auto__ = (function (){var temp__5751__auto__ = cljs.core.re_matches(/(.*)\$/,s);
if(cljs.core.truth_(temp__5751__auto__)){
...
var len__4829__auto___31369 = arguments.length;
var i__4830__auto___31370 = (0);
while(true){
if((i__4830__auto___31370 < len__4829__auto___31369)){
args__4835__auto__.push((arguments[i__4830__auto___31370]));

var G__31371 = (i__4830__auto___31370 + (1));
i__4830__auto___31370 = G__31371;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__31134){
var vec__31135 = p__31134;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31135,(0),null);
...
var G__31372 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__31373 = cljs.core.butlast(remaining_tokens);
name_tokens = G__31372;
remaining_tokens = G__31373;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq31126){
var G__31127 = cljs.core.first(seq31126);
var seq31126__$1 = cljs.core.next(seq31126);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__31127,seq31126__$1);
}));
...
var vec__31153 = cljs.core.split_with((function (p1__31152_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__31152_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31153,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31153,(1),null);
...
var vec__31167 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31167,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31167,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__31375 = cljs.core.rest(remaining_tokens);
var G__31376 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__31375;
name_tokens = G__31376;
continue;
} else {
...
var vec__31182 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31182,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31182,(1),null);
var vec__31185 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31185,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31185,(1),null);
var vec__31188 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31188,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31188,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31188,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31188,(3),null);
...
var vec__31209 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31209,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31209,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31209,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31209,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31209,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31209,(5),null);
...
if(cljs.core.truth_(temp__5751__auto__)){
var vec__31220 = temp__5751__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31220,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31220,(1),null);
var vec__31223 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31223,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31223,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__31235 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__31235) : devtools.munging.parse_fn_info_deep.call(null,G__31235));
})()));
}
} else {
return fn_info;
...
var G__31387 = (arity + (1));
var G__31388 = (function (){var temp__5751__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5751__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__31245){
var vec__31247 = p__31245;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31247,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31247,(1),null);
...
var fixed_arities = devtools.munging.collect_fn_fixed_arities(f,(function (){var or__4223__auto__ = max_fixed_arity;
if(cljs.core.truth_(or__4223__auto__)){
return or__4223__auto__;
} else {
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__31256_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__31256_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__31258_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__31258_SHARP_);
}),sorted_infos);
...
var args__4835__auto__ = [];
var len__4829__auto___31398 = arguments.length;
var i__4830__auto___31399 = (0);
while(true){
if((i__4830__auto___31399 < len__4829__auto___31398)){
args__4835__auto__.push((arguments[i__4830__auto___31399]));

var G__31400 = (i__4830__auto___31399 + (1));
i__4830__auto___31399 = G__31400;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__31266){
var vec__31268 = p__31266;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31268,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq31263){
var G__31264 = cljs.core.first(seq31263);
var seq31263__$1 = cljs.core.next(seq31263);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__31264,seq31263__$1);
}));
...
var G__31272 = arg;
var G__31272__$1 = (((G__31272 instanceof cljs.core.Keyword))?G__31272.fqn:null);
switch (G__31272__$1) {
...
return devtools.munging.args_lists_to_strings(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic((function (){var or__4223__auto__ = devtools.munging.collect_fn_arities(f);
if(cljs.core.truth_(or__4223__auto__)){
return or__4223__auto__;
} else {
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?protocol_ns:null)),(((!(cljs.core.empty_QMARK_(protocol_name))))?[(cljs.core.truth_(include_protocol_ns_QMARK_)?".":null),cljs.core.str.cljs$core$IFn$_invoke$arity$1(protocol_name)].join(''):null),(((!(cljs.core.empty_QMARK_(protocol_method))))?[(cljs.core.truth_((function (){var or__4223__auto__ = include_protocol_ns_QMARK_;
if(cljs.core.truth_(or__4223__auto__)){
return or__4223__auto__;
} else {
...
var map__31298 = options;
var map__31298__$1 = cljs.core.__destructure_map(map__31298);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31298__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31298__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31298__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31298__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__31299 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31299,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31299,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31299,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31299,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31299,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31299,(5),null);
...
if(cljs.core.truth_(and__4221__auto__)){
return cljs.core.not((function (){var and__4221__auto____$1 = silence_common_protocols_QMARK_;
...
var o__30491__auto__ = f;
return (o__30491__auto__["getBasis"]).call(o__30491__auto__);
});
/**
...
}catch (e31309){var _e__30527__auto__ = e31309;
...
var G__31419 = (obj[cljs.core.first(path)]);
var G__31420 = cljs.core.rest(path);
obj = G__31419;
path = G__31420;
continue;
} else {
...
var _STAR_ = (function (accum,p__31327){
var vec__31328 = p__31327;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31328,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31328,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__31333){
var vec__31335 = p__31333;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31335,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31335,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31335,(2),null);
...
var post_process = (function (p__31343){
var vec__31344 = p__31343;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31344,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31344,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__31341_SHARP_){
return (obj[cljs.core.first(p1__31341_SHARP_)]);
}),sorted_matches);
