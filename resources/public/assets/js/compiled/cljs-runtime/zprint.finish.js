...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__40516_SHARP_){
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__40516_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__40516_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__40520){
var vec__40521 = p__40520;
var low = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40521,(0),null);
var high = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40521,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__40526,s,color,element,idx){
var map__40527 = p__40526;
var map__40527__$1 = cljs.core.__destructure_map(map__40527);
var style_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40527__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40527__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40527__$1,new cljs.core.Keyword(null,"select","select",1147833503));
...
var G__40533 = (function (){var or__4223__auto__ = color;
...
var fexpr__40532 = (function (){var G__40534 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(element,new cljs.core.Keyword(null,"cursor-element","cursor-element",-616791907)))?(function (){
...
return (style_map.cljs$core$IFn$_invoke$arity$1 ? style_map.cljs$core$IFn$_invoke$arity$1(G__40534) : style_map.call(null,G__40534));
})();
return (fexpr__40532.cljs$core$IFn$_invoke$arity$1 ? fexpr__40532.cljs$core$IFn$_invoke$arity$1(G__40533) : fexpr__40532.call(null,G__40533));
} else {
return null;
}
});
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__40545){
var vec__40548 = p__40545;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40548,(0),null);
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40548,(1),null);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40548,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__40556){
var vec__40557 = p__40556;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40557,(0),null);
var keyword_color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40557,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40557,(2),null);
...
var G__40731 = cljs.core.next(ssv);
var G__40732 = (this_ssv == null);
var G__40733 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__40734 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && ((!((this_ssv == null))))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.gc_vec_to_style_vec(ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec(ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,this_ssv)
)));
ssv = G__40731;
doing_nil_QMARK_ = G__40732;
last_elide = G__40733;
out = G__40734;
continue;
}
...
var vec__40591 = cljs.core.first(remaining_cvec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40591,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40591,(1),null);
var element_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40591,(2),null);
...
var G__40737 = cljs.core.next(remaining_cvec);
var G__40738 = new_idx;
var G__40739 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__40737;
idx = G__40738;
out = G__40739;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__40629,cursor_vec){
var vec__40630 = p__40629;
var focus_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40630,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40630,(1),null);
var focus_vec = vec__40630;
...
var vec__40633 = cljs.core.split_at(focus_start,gcw_vec);
var front = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40633,(0),null);
var back = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40633,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__40637){
var vec__40639 = p__40637;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40639,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40639,(1),null);
if((color == null)){
return s;
} else {
...
(zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__40651,existing_count){
var vec__40652 = p__40651;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40652,(0),null);
var cursor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40652,(1),null);
...
return cljs.core.filterv((function (p1__40645_SHARP_){
return (!(cljs.core.empty_QMARK_(cljs.core.first(p1__40645_SHARP_))));
...
var vec__40677 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40677,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40677,(1),null);
var cvec_element = vec__40677;
if((cvec_element == null)){
var G__40798 = cljs.core.next(cvec_nl);
var G__40799 = (idx + (1));
var G__40800 = start;
var G__40801 = out;
cvec_nl = G__40798;
...
var G__40804 = cljs.core.next(cvec_nl);
var G__40805 = (idx + (1));
var G__40806 = idx;
var G__40807 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__40804;
idx = G__40805;
start = G__40806;
out = G__40807;
...
var G__40810 = cljs.core.next(cvec_nl);
var G__40811 = (idx + (1));
var G__40812 = (idx + (1));
var G__40813 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__40810;
idx = G__40811;
start = G__40812;
out = G__40813;
...
var G__40815 = cljs.core.next(cvec_nl);
var G__40816 = (idx + (1));
var G__40817 = idx;
var G__40818 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null)),cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,idx], null)));
cvec_nl = G__40815;
idx = G__40816;
start = G__40817;
out = G__40818;
...
var G__40821 = cljs.core.next(cvec_nl);
var G__40822 = (idx + (1));
var G__40823 = start;
var G__40824 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__40821;
idx = G__40822;
start = G__40823;
out = G__40824;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__40685_SHARP_,p2__40684_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__40684_SHARP_)){
return cljs.core.reduced(p1__40685_SHARP_);
} else {
return (p1__40685_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__40691,p__40692){
var vec__40693 = p__40691;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40693,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40693,(1),null);
var vec__40696 = p__40692;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40696,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40696,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__40701,cvec,focus_vec){
var map__40702 = p__40701;
var map__40702__$1 = cljs.core.__destructure_map(map__40702);
var options = map__40702__$1;
var map__40703 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40702__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
var map__40703__$1 = cljs.core.__destructure_map(map__40703);
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40703__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40703__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40703__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__40700_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__40700_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
}),path_vecs);
