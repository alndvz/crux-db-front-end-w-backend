...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__37105_SHARP_){
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__37105_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__37105_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__37107){
var vec__37108 = p__37107;
var low = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37108,(0),null);
var high = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37108,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__37119,s,color,element,idx){
var map__37121 = p__37119;
var map__37121__$1 = cljs.core.__destructure_map(map__37121);
var style_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37121__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37121__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37121__$1,new cljs.core.Keyword(null,"select","select",1147833503));
...
var G__37128 = (function (){var or__4223__auto__ = color;
...
var fexpr__37127 = (function (){var G__37131 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(element,new cljs.core.Keyword(null,"cursor-element","cursor-element",-616791907)))?(function (){
...
return (style_map.cljs$core$IFn$_invoke$arity$1 ? style_map.cljs$core$IFn$_invoke$arity$1(G__37131) : style_map.call(null,G__37131));
})();
return (fexpr__37127.cljs$core$IFn$_invoke$arity$1 ? fexpr__37127.cljs$core$IFn$_invoke$arity$1(G__37128) : fexpr__37127.call(null,G__37128));
} else {
return null;
}
});
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__37132){
var vec__37133 = p__37132;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37133,(0),null);
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37133,(1),null);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37133,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__37136){
var vec__37137 = p__37136;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37137,(0),null);
var keyword_color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37137,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37137,(2),null);
...
var G__37370 = cljs.core.next(ssv);
var G__37371 = (this_ssv == null);
var G__37372 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__37373 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && ((!((this_ssv == null))))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.gc_vec_to_style_vec(ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec(ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,this_ssv)
)));
ssv = G__37370;
doing_nil_QMARK_ = G__37371;
last_elide = G__37372;
out = G__37373;
continue;
}
...
var vec__37177 = cljs.core.first(remaining_cvec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37177,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37177,(1),null);
var element_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37177,(2),null);
...
var G__37381 = cljs.core.next(remaining_cvec);
var G__37382 = new_idx;
var G__37383 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__37381;
idx = G__37382;
out = G__37383;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__37203,cursor_vec){
var vec__37204 = p__37203;
var focus_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37204,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37204,(1),null);
var focus_vec = vec__37204;
...
var vec__37207 = cljs.core.split_at(focus_start,gcw_vec);
var front = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37207,(0),null);
var back = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37207,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__37215){
var vec__37216 = p__37215;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37216,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37216,(1),null);
if((color == null)){
return s;
} else {
...
(zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__37223,existing_count){
var vec__37224 = p__37223;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37224,(0),null);
var cursor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37224,(1),null);
...
return cljs.core.filterv((function (p1__37220_SHARP_){
return (!(cljs.core.empty_QMARK_(cljs.core.first(p1__37220_SHARP_))));
...
var vec__37260 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37260,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37260,(1),null);
var cvec_element = vec__37260;
if((cvec_element == null)){
var G__37408 = cljs.core.next(cvec_nl);
var G__37409 = (idx + (1));
var G__37410 = start;
var G__37411 = out;
cvec_nl = G__37408;
...
var G__37412 = cljs.core.next(cvec_nl);
var G__37413 = (idx + (1));
var G__37414 = idx;
var G__37415 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__37412;
idx = G__37413;
start = G__37414;
out = G__37415;
...
var G__37416 = cljs.core.next(cvec_nl);
var G__37417 = (idx + (1));
var G__37418 = (idx + (1));
var G__37419 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__37416;
idx = G__37417;
start = G__37418;
out = G__37419;
...
var G__37420 = cljs.core.next(cvec_nl);
var G__37421 = (idx + (1));
var G__37422 = idx;
var G__37423 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null)),cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,idx], null)));
cvec_nl = G__37420;
idx = G__37421;
start = G__37422;
out = G__37423;
...
var G__37427 = cljs.core.next(cvec_nl);
var G__37428 = (idx + (1));
var G__37429 = start;
var G__37430 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__37427;
idx = G__37428;
start = G__37429;
out = G__37430;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__37281_SHARP_,p2__37280_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__37280_SHARP_)){
return cljs.core.reduced(p1__37281_SHARP_);
} else {
return (p1__37281_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__37295,p__37296){
var vec__37299 = p__37295;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37299,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37299,(1),null);
var vec__37302 = p__37296;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37302,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37302,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__37337,cvec,focus_vec){
var map__37338 = p__37337;
var map__37338__$1 = cljs.core.__destructure_map(map__37338);
var options = map__37338__$1;
var map__37339 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37338__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
var map__37339__$1 = cljs.core.__destructure_map(map__37339);
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37339__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37339__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37339__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__37331_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__37331_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
}),path_vecs);
