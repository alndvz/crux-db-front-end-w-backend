...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4474__auto__,k41151,else__4475__auto__){
var self__ = this;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4495__auto__,p__41193){
var vec__41195 = p__41193;
var k__4496__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41195,(0),null);
var v__4497__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41195,(1),null);
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__41150){
var self__ = this;
var G__41150__$1 = this;
return (new cljs.core.RecordIter((0),G__41150__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tag","tag",-1290361223),new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this41152,other41153){
var self__ = this;
var this41152__$1 = this;
return (((!((other41153 == null)))) && ((((this41152__$1.constructor === other41153.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this41152__$1.tag,other41153.tag)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this41152__$1.wrap_fn,other41153.wrap_fn)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this41152__$1.wrap_length,other41153.wrap_length)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this41152__$1.seq_fn,other41153.seq_fn)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this41152__$1.children,other41153.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this41152__$1.__extmap,other41153.__extmap)))))))))))))));
}));
...
var self__ = this;
var this$__$1 = this;
var G__41237 = rewrite_clj.node.protocols.sexprs(self__.children);
return (self__.seq_fn.cljs$core$IFn$_invoke$arity$1 ? self__.seq_fn.cljs$core$IFn$_invoke$arity$1(G__41237) : self__.seq_fn.call(null,G__41237));
}));
...
var self__ = this;
var this$__$1 = this;
var G__41242 = rewrite_clj.node.protocols.concat_strings(self__.children);
return (self__.wrap_fn.cljs$core$IFn$_invoke$arity$1 ? self__.wrap_fn.cljs$core$IFn$_invoke$arity$1(G__41242) : self__.wrap_fn.call(null,G__41242));
}));
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4479__auto__,k41151){
var self__ = this;
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4480__auto__,k__4481__auto__,G__41150){
var self__ = this;
var this__4480__auto____$1 = this;
var pred__41263 = cljs.core.keyword_identical_QMARK_;
var expr__41264 = k__4481__auto__;
if(cljs.core.truth_((pred__41263.cljs$core$IFn$_invoke$arity$2 ? pred__41263.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__41264) : pred__41263.call(null,new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__41264)))){
return (new rewrite_clj.node.seq.SeqNode(G__41150,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__41263.cljs$core$IFn$_invoke$arity$2 ? pred__41263.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),expr__41264) : pred__41263.call(null,new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),expr__41264)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,G__41150,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__41263.cljs$core$IFn$_invoke$arity$2 ? pred__41263.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),expr__41264) : pred__41263.call(null,new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),expr__41264)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,G__41150,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__41263.cljs$core$IFn$_invoke$arity$2 ? pred__41263.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),expr__41264) : pred__41263.call(null,new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),expr__41264)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,G__41150,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__41263.cljs$core$IFn$_invoke$arity$2 ? pred__41263.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__41264) : pred__41263.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__41264)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,G__41150,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4481__auto__,G__41150),null));
}
}
}
}
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4471__auto__,G__41150){
var self__ = this;
var this__4471__auto____$1 = this;
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,G__41150,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.seq.map__GT_SeqNode = (function rewrite_clj$node$seq$map__GT_SeqNode(G__41161){
var extmap__4512__auto__ = (function (){var G__41289 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__41161,new cljs.core.Keyword(null,"tag","tag",-1290361223),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),new cljs.core.Keyword(null,"children","children",-940561982)], 0));
if(cljs.core.record_QMARK_(G__41161)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__41289);
} else {
return G__41289;
}
})();
return (new rewrite_clj.node.seq.SeqNode(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(G__41161),new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130).cljs$core$IFn$_invoke$arity$1(G__41161),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519).cljs$core$IFn$_invoke$arity$1(G__41161),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231).cljs$core$IFn$_invoke$arity$1(G__41161),new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__41161),null,cljs.core.not_empty(extmap__4512__auto__),null));
});
...
return rewrite_clj.node.seq.__GT_SeqNode(new cljs.core.Keyword(null,"list","list",765357683),rewrite_clj.node.seq.wrap_list,(2),(function (p1__41293_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.list,p1__41293_SHARP_);
}),children);
});
/**
...
return rewrite_clj.node.seq.__GT_SeqNode(new cljs.core.Keyword(null,"map","map",1371690461),rewrite_clj.node.seq.wrap_map,(2),(function (p1__41305_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,p1__41305_SHARP_);
}),children);
});
