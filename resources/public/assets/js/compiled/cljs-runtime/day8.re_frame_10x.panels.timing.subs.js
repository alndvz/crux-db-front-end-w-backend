...
return cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__39615_SHARP_){
return ((day8.re_frame_10x.tools.metamorphic.request_animation_frame_QMARK_(p1__39615_SHARP_)) || (day8.re_frame_10x.tools.metamorphic.request_animation_frame_end_QMARK_(p1__39615_SHARP_)));
}),traces);
})], 0));
...
var len__4829__auto___39681 = arguments.length;
var i__4830__auto___39682 = (0);
while(true){
if((i__4830__auto___39682 < len__4829__auto___39681)){
args_arr__4850__auto__.push((arguments[i__4830__auto___39682]));

var G__39684 = (i__4830__auto___39682 + (1));
i__4830__auto___39682 = G__39684;
continue;
} else {
}
break;
...
return day8.re_frame_10x.panels.timing.subs._PLUS_nil.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__4851__auto__);
...
/** @this {Function} */
(day8.re_frame_10x.panels.timing.subs._PLUS_nil.cljs$lang$applyTo = (function (seq39625){
var G__39626 = cljs.core.first(seq39625);
var seq39625__$1 = cljs.core.next(seq39625);
var G__39627 = cljs.core.first(seq39625__$1);
var seq39625__$2 = cljs.core.next(seq39625__$1);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__39626,G__39627,seq39625__$2);
}));

(day8.re_frame_10x.panels.timing.subs._PLUS_nil.cljs$lang$maxFixedArity = (2));

day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword("day8.re-frame-10x.panels.timing.subs","animation-frame-time","day8.re-frame-10x.panels.timing.subs/animation-frame-time",1191520772),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("day8.re-frame-10x.panels.timing.subs","animation-frame-traces","day8.re-frame-10x.panels.timing.subs/animation-frame-traces",-1778771106)], null),new cljs.core.Keyword(null,"<-","<-",760412998),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("day8.re-frame-10x.panels.traces.subs","filtered-by-epoch-always","day8.re-frame-10x.panels.traces.subs/filtered-by-epoch-always",-1807060768)], null),(function (p__39638,p__39639){
var vec__39640 = p__39638;
var af_start_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39640,(0),null);
var epoch_traces = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39640,(1),null);
var vec__39643 = p__39639;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39643,(0),null);
var frame_number = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39643,(1),null);
...
var vec__39648 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(frame_pairs,(frame_number - (1)));
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39648,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39648,(1),null);
...
var map__39665 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(match,new cljs.core.Keyword(null,"timing","timing",-1849225195));
var map__39665__$1 = cljs.core.__destructure_map(map__39665);
var event_time = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39665__$1,new cljs.core.Keyword("re-frame","event-time","re-frame/event-time",-1349372188));
var event_handler_time = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39665__$1,new cljs.core.Keyword("re-frame","event-handler-time","re-frame/event-handler-time",1278050644));
var event_dofx_time = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39665__$1,new cljs.core.Keyword("re-frame","event-dofx-time","re-frame/event-dofx-time",650880716));
var event_run_time = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39665__$1,new cljs.core.Keyword("re-frame","event-run-time","re-frame/event-run-time",1941554897));
