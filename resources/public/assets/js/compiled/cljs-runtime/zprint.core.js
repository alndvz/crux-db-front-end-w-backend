...
var vec__42995 = (cljs.core.truth_(new cljs.core.Keyword(null,"zipper?","zipper?",-1061271842).cljs$core$IFn$_invoke$arity$1(options))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [coll,options], null):(cljs.core.truth_(new cljs.core.Keyword(null,"parse-string?","parse-string?",2006674325).cljs$core$IFn$_invoke$arity$1(options))?((typeof coll === 'string')?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [zprint.core.get_zipper(options,coll),options], null):(function(){throw (new Error(["Collection is not a string yet"," :parse-string? specified!"].join('')))})()):(cljs.core.truth_(new cljs.core.Keyword(null,"zloc?","zloc?",-1457193855).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"focus","focus",234677911).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"output","output",-1105869043).cljs$core$IFn$_invoke$arity$1(options))))?(function (){var vec__43001 = zprint.zutil.find_root_and_path_nw(coll);
var root = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43001,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43001,(1),null);
...
var input = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42995,(0),null);
var options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42995,(1),null);
 ...
 */
zprint.core.process_rest_options = (function zprint$core$process_rest_options(internal_options,p__43012){
var vec__43013 = p__43012;
var width_or_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43013,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43013,(1),null);
...
var width_or_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43017,(0),null);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43017,(1),null);
...
var vec__43053 = zprint.config.perform_remove(null,null,zprint.config.get_options(),rest_options);
var internal_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43053,(0),null);
var rest_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43053,(1),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43053,(2),null);
var vec__43056 = zprint.config.apply_style(null,null,internal_map,rest_options__$1);
var updated_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43056,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43056,(1),null);
var style_errors = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43056,(2),null);
 ...
 */
zprint.core.range_vec = (function zprint$core$range_vec(v,p__43083){
var vec__43084 = p__43083;
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43084,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43084,(1),null);
...
var vec__43091 = tuple;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43091,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43091,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43091,(2),null);
...
var vec__43117 = cljs.core.first(style_vec);
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43117,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43117,(1),null);
var e = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43117,(2),null);
var tuple = vec__43117;
...
var G__43474 = cljs.core.next(style_vec);
var G__43475 = ends_w_blanks_QMARK_;
var G__43476 = tuple;
var G__43477 = (cljs.core.truth_(add_previous_to_out_QMARK_)?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,previous_tuple):out);
style_vec = G__43474;
previous_ends_w_blanks_QMARK_ = G__43475;
previous_tuple = G__43476;
out = G__43477;
continue;
}
break;
...
var len__4829__auto___43478 = arguments.length;
var i__4830__auto___43479 = (0);
while(true){
if((i__4830__auto___43479 < len__4829__auto___43478)){
args__4835__auto__.push((arguments[i__4830__auto___43479]));

var G__43480 = (i__4830__auto___43479 + (1));
i__4830__auto___43479 = G__43480;
continue;
} else {
}
break;
...
var vec__43154 = zprint.core.process_rest_options(internal_options,rest);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43154,(0),null);
var rest_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43154,(1),null);
...
var result = (function (){var G__43159 = zprint.core.parse_string_all_options(rest_options);
var G__43160 = zprint.core.zprint_str_internal;
var G__43161 = ":parse-string-all? call";
var G__43162 = (function (){var G__43163 = rewrite_clj.parser.parse_string_all(coll);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__43163) : zprint.zutil.edn_STAR_.call(null,G__43163));
})();
return (zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4 ? zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4(G__43159,G__43160,G__43161,G__43162) : zprint.core.process_multiple_forms.call(null,G__43159,G__43160,G__43161,G__43162));
})();
if(cljs.core.truth_(new cljs.core.Keyword(null,"dbg?","dbg?",1845730771).cljs$core$IFn$_invoke$arity$1(rest_options))){
...
var vec__43167 = zprint.core.zprint_STAR_(coll,special_option,actual_options);
var cvec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43167,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43167,(1),null);
...
/** @this {Function} */
(zprint.core.zprint_str_internal.cljs$lang$applyTo = (function (seq43147){
...
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__43148,G__43149,seq43147__$2);
}));
...
var args__4835__auto__ = [];
var len__4829__auto___43495 = arguments.length;
var i__4830__auto___43496 = (0);
while(true){
if((i__4830__auto___43496 < len__4829__auto___43495)){
args__4835__auto__.push((arguments[i__4830__auto___43496]));

var G__43497 = (i__4830__auto___43496 + (1));
i__4830__auto___43496 = G__43497;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.zprint_str.cljs$lang$applyTo = (function (seq43183){
var G__43184 = cljs.core.first(seq43183);
var seq43183__$1 = cljs.core.next(seq43183);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__43184,seq43183__$1);
}));
...
var args__4835__auto__ = [];
var len__4829__auto___43500 = arguments.length;
var i__4830__auto___43501 = (0);
while(true){
if((i__4830__auto___43501 < len__4829__auto___43500)){
args__4835__auto__.push((arguments[i__4830__auto___43501]));

var G__43502 = (i__4830__auto___43501 + (1));
i__4830__auto___43501 = G__43502;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.czprint_str.cljs$lang$applyTo = (function (seq43187){
var G__43188 = cljs.core.first(seq43187);
var seq43187__$1 = cljs.core.next(seq43187);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__43188,seq43187__$1);
}));
...
var args__4835__auto__ = [];
var len__4829__auto___43503 = arguments.length;
var i__4830__auto___43504 = (0);
while(true){
if((i__4830__auto___43504 < len__4829__auto___43503)){
args__4835__auto__.push((arguments[i__4830__auto___43504]));

var G__43505 = (i__4830__auto___43504 + (1));
i__4830__auto___43504 = G__43505;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.zprint.cljs$lang$applyTo = (function (seq43189){
var G__43190 = cljs.core.first(seq43189);
var seq43189__$1 = cljs.core.next(seq43189);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__43190,seq43189__$1);
}));
...
var args__4835__auto__ = [];
var len__4829__auto___43506 = arguments.length;
var i__4830__auto___43507 = (0);
while(true){
if((i__4830__auto___43507 < len__4829__auto___43506)){
args__4835__auto__.push((arguments[i__4830__auto___43507]));

var G__43508 = (i__4830__auto___43507 + (1));
i__4830__auto___43507 = G__43508;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.czprint.cljs$lang$applyTo = (function (seq43191){
var G__43192 = cljs.core.first(seq43191);
var seq43191__$1 = cljs.core.next(seq43191);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__43192,seq43191__$1);
}));
 ...
 */
zprint.core.process_form = (function zprint$core$process_form(rest_options,zprint_fn,zprint_specifier,p__43198,form){
var vec__43199 = p__43198;
var next_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43199,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43199,(1),null);
var indent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43199,(2),null);
var zprint_num = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43199,(3),null);
var comment_QMARK_ = zprint.zutil.zcomment_QMARK_(form);
var whitespace_form_QMARK_ = zprint.zutil.whitespace_QMARK_(form);
var vec__43202 = (cljs.core.truth_((function (){var and__4221__auto__ = comment_QMARK_;
if(cljs.core.truth_(and__4221__auto__)){
...
var new_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43202,(0),null);
var error_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43202,(1),null);
...
var G__43519 = cljs.core.next(sos);
var G__43520 = comment_QMARK_;
var G__43521 = (function (){var or__4223__auto__ = (!(empty_string_QMARK_));
if(or__4223__auto__){
return or__4223__auto__;
} else {
...
var G__43522 = ((empty_string_QMARK_)?out:((cljs.core.not(start_interpolating_QMARK_))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,s):(cljs.core.truth_(previous_comment_QMARK_)?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,"\n"),s):cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,interpose_str),s)
)));
sos = G__43519;
previous_comment_QMARK_ = G__43520;
start_interpolating_QMARK_ = G__43521;
out = G__43522;
continue;
}
break;
...
try{var vec__43364 = zprint.core.remove_shebang(file_str);
var shebang = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43364,(0),null);
var file_str__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43364,(1),null);
...
var vec__43367 = (cljs.core.truth_((function (){var or__4223__auto__ = range_start__$1;
if(cljs.core.truth_(or__4223__auto__)){
return or__4223__auto__;
} else {
return range_end__$1;
...
var actual_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43367,(0),null);
var actual_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43367,(1),null);
...
var vec__43370 = (cljs.core.truth_((function (){var and__4221__auto__ = actual_start;
if(cljs.core.truth_(and__4221__auto__)){
return actual_end;
} else {
return and__4221__auto__;
...
var before_lines = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43370,(0),null);
var range = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43370,(1),null);
var after_lines = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43370,(2),null);
...
var forms = (function (){var G__43386 = rewrite_clj.parser.parse_string_all(filestring__$1);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__43386) : zprint.zutil.edn_STAR_.call(null,G__43386));
})();
