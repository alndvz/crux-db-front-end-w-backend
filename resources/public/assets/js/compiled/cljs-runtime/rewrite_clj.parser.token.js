...
return rewrite_clj.reader.read_until(reader,(function (p1__41569_SHARP_){
return ((cljs.core.not((allowed_QMARK_.cljs$core$IFn$_invoke$arity$1 ? allowed_QMARK_.cljs$core$IFn$_invoke$arity$1(p1__41569_SHARP_) : allowed_QMARK_.call(null,p1__41569_SHARP_)))) && (rewrite_clj.reader.whitespace_or_boundary_QMARK_(p1__41569_SHARP_)));
}));
});
...
var G__41577 = (rewrite_clj.reader.read_string.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.reader.read_string.cljs$core$IFn$_invoke$arity$1(s) : rewrite_clj.reader.read_string.call(null,s));
var G__41578 = s;
return (rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2(G__41577,G__41578) : rewrite_clj.node.token_node.call(null,G__41577,G__41578));
}
});
/**
