...
var G__38441 = (i__4830__auto___38437 + (1));
i__4830__auto___38437 = G__38441;
continue;
} else {
}
break;
...
(rewrite_clj.zip.findz.tag_predicate.cljs$core$IFn$_invoke$arity$variadic = (function (t,p__38330){
var vec__38331 = p__38330;
var additional = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38331,(0),null);
...
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.tag(p1__38327_SHARP_),t);
});
}
}));
...
/** @this {Function} */
(rewrite_clj.zip.findz.tag_predicate.cljs$lang$applyTo = (function (seq38328){
var G__38329 = cljs.core.first(seq38328);
var seq38328__$1 = cljs.core.next(seq38328);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__38329,seq38328__$1);
}));

rewrite_clj.zip.findz.in_range_QMARK_ = (function rewrite_clj$zip$findz$in_range_QMARK_(p__38335,p__38336){
var map__38337 = p__38335;
var map__38337__$1 = cljs.core.__destructure_map(map__38337);
var row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38337__$1,new cljs.core.Keyword(null,"row","row",-570139521));
var col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38337__$1,new cljs.core.Keyword(null,"col","col",-1959363084));
var end_row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38337__$1,new cljs.core.Keyword(null,"end-row","end-row",-545103581));
var end_col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38337__$1,new cljs.core.Keyword(null,"end-col","end-col",-724155879));
var map__38338 = p__38336;
var map__38338__$1 = cljs.core.__destructure_map(map__38338);
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38338__$1,new cljs.core.Keyword(null,"row","row",-570139521));
var c = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38338__$1,new cljs.core.Keyword(null,"col","col",-1959363084));
...
return cljs.core.last(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__38364_SHARP_){
var and__4221__auto__ = (p_QMARK_.cljs$core$IFn$_invoke$arity$1 ? p_QMARK_.cljs$core$IFn$_invoke$arity$1(p1__38364_SHARP_) : p_QMARK_.call(null,p1__38364_SHARP_));
if(cljs.core.truth_(and__4221__auto__)){
return rewrite_clj.zip.findz.in_range_QMARK_(cljs.core.meta(clojure.zip.node(p1__38364_SHARP_)),pos);
} else {
return and__4221__auto__;
}
...
var G__38392 = zloc;
var G__38392__$1 = (((G__38392 == null))?null:(f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__38392) : f.call(null,G__38392)));
if((G__38392__$1 == null)){
return null;
} else {
return rewrite_clj.zip.findz.find.cljs$core$IFn$_invoke$arity$3(G__38392__$1,f,p_QMARK_);
}
}));
...
return rewrite_clj.zip.findz.find.cljs$core$IFn$_invoke$arity$3(zloc,f,(function (p1__38395_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.tag(p1__38395_SHARP_),t);
}));
}));
...
return rewrite_clj.zip.findz.find_last_by_pos.cljs$core$IFn$_invoke$arity$3(zloc,pos,(function (p1__38407_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.tag(p1__38407_SHARP_),t);
}));
});
/**
...
var p_QMARK_ = ((cljs.core.set_QMARK_(v))?cljs.core.comp.cljs$core$IFn$_invoke$arity$2(v,rewrite_clj.zip.base.sexpr):(function (p1__38417_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.sexpr(p1__38417_SHARP_),v);
}));
