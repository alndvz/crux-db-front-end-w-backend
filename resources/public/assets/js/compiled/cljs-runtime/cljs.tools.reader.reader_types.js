...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_36699 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_36699(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_36700 = (function (reader){
var x__4521__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_36700(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_36701 = (function (reader,ch){
var x__4521__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_36701(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_36702 = (function (reader){
var x__4521__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_36702(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_36704 = (function (reader){
var x__4521__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_36704(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_36705 = (function (reader){
var x__4521__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_36705(reader);
}
});
...
var G__36741 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__36742 = s.append(c);
c = G__36741;
s = G__36742;
continue;
}
