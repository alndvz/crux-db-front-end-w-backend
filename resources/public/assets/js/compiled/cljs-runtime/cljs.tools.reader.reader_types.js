...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_33243 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_33243(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_33245 = (function (reader){
var x__4521__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_33245(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_33247 = (function (reader,ch){
var x__4521__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_33247(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_33248 = (function (reader){
var x__4521__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_33248(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_33250 = (function (reader){
var x__4521__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_33250(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_33251 = (function (reader){
var x__4521__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_33251(reader);
}
});
...
var G__33297 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__33298 = s.append(c);
c = G__33297;
s = G__33298;
continue;
}
