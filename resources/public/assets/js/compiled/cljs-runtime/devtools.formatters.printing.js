...
var len__4829__auto___28030 = arguments.length;
var i__4830__auto___28031 = (0);
while(true){
if((i__4830__auto___28031 < len__4829__auto___28030)){
args__4835__auto__.push((arguments[i__4830__auto___28031]));

var G__28033 = (i__4830__auto___28031 + (1));
i__4830__auto___28031 = G__28033;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq27963){
...
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27964,G__27965,seq27963__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__27995_SHARP_){
return (!((cljs.core.meta(p1__27995_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28016__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e28017){var _e__26711__auto__ = e28017;
return false;
}})();
if(cljs.core.truth_(or__4223__auto__)){
return or__4223__auto__;
...
}catch (e28019){var _e__26711__auto__ = e28019;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__28021 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__28022 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__28022);

try{var map__28023 = opts;
var map__28023__$1 = cljs.core.__destructure_map(map__28023);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28023__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__28021);
}});
...
var temp__5751__auto___28048 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5751__auto___28048)){
var managed_print_level_28049 = temp__5751__auto___28048;
var _STAR_print_level_STAR__orig_val__28026_28050 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__28027_28051 = managed_print_level_28049;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__28027_28051);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__28024_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__28024_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__28026_28050);
}} else {
job_fn();
}
