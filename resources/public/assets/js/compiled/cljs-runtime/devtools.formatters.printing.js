...
var len__4829__auto___31474 = arguments.length;
var i__4830__auto___31475 = (0);
while(true){
if((i__4830__auto___31475 < len__4829__auto___31474)){
args__4835__auto__.push((arguments[i__4830__auto___31475]));

var G__31476 = (i__4830__auto___31475 + (1));
i__4830__auto___31475 = G__31476;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq31412){
...
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__31413,G__31414,seq31412__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__31441_SHARP_){
return (!((cljs.core.meta(p1__31441_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31446__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e31447){var _e__30527__auto__ = e31447;
return false;
}})();
if(cljs.core.truth_(or__4223__auto__)){
return or__4223__auto__;
...
}catch (e31451){var _e__30527__auto__ = e31451;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__31456 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__31457 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__31457);

try{var map__31458 = opts;
var map__31458__$1 = cljs.core.__destructure_map(map__31458);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31458__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__31456);
}});
...
var temp__5751__auto___31504 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5751__auto___31504)){
var managed_print_level_31505 = temp__5751__auto___31504;
var _STAR_print_level_STAR__orig_val__31460_31506 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__31461_31507 = managed_print_level_31505;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__31461_31507);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__31459_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__31459_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__31460_31506);
}} else {
job_fn();
}
