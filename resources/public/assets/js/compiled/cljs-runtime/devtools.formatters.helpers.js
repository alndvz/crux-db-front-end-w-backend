...
var G__27952 = devtools.prefs.pref(v);
v = G__27952;
continue;
} else {
return v;
...
var and__4221__auto__ = cljs.core.not(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"disable-cljs-fn-formatting","disable-cljs-fn-formatting",1903786837)));
if(and__4221__auto__){
var and__4221__auto____$1 = (!(cljs.core.var_QMARK_(value)));
...
}catch (e27890){var _e__26711__auto__ = e27890;
return false;
}})();
...
}catch (e27892){var _e__26711__auto__ = e27892;
return false;
}})();
...
}catch (e27896){var _e__26711__auto__ = e27896;
return false;
}}
}
});
...
var and__4221__auto____$1 = (!(devtools.formatters.helpers.is_prototype_QMARK_(f)));
if(and__4221__auto____$1){
...
var or__4223__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_(value);
if(cljs.core.truth_(or__4223__auto__)){
return or__4223__auto__;
} else {
...
var and__4221__auto__ = (function (){var or__4223__auto__ = devtools.formatters.helpers.cljs_land_value_QMARK_(value);
if(cljs.core.truth_(or__4223__auto__)){
return or__4223__auto__;
} else {
...
var vec__27922 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27922,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27922,(1),null);
...
var and__4221__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_(value);
if(cljs.core.truth_(and__4221__auto__)){
...
return cljs.core.some((function (p1__27929_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__27929_SHARP_);
}),template);
});
